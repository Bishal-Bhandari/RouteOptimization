...
def categories(tags):
    tag_dict = {
        ...
        14: ["pharmacy", 1, 3],
        15: ["doctors", 1, 3],
        16: ["vending_machine", 2, 5],
        17: ["pub", 1, 7],
        18: ["telephone", 2, 5],
        19: ["community_centre", 2, 9],
        20: ["cinema", 2, 6],
        21: ["atm", 1, 5],
        22: ["cafe", 1, 7],
        23: ["bicycle_parking", 1, 1],
        24: ["theatre", 2, 6],
        25: ["toilets", 1, 3],
        26: ["hunting_stand", 3, 8],
        27: ["fire_station", 1, 3],
        28: ["bts", 3, 1],
        29: ["driving_school", 2, 2],
        30: ["ice_cream", 2, 7],
        31: ["bar", 1, 7],
        32: ["drinking_water", 2, 8],
        33: ["waste_disposal", 2, 8],
        34: ["parcel_locker", 2, 9],
        35: ["ferry_terminal", 2, 1],
        36: ["parking_entrance", 3, 1],
        37: ["music_school", 2, 2],
        38: ["nightclub", 2, 7],
        39: ["car_sharing", 2, 1],
        40: ["university", 1, 2],
        41: ["stripclub", 3, 7],
        42: ["kindergarten", 1, 2],
        43: ["motorcycle_parking", 2, 1],
        44: ["swingerclub", 3, 7],
        45: ["kneipp_water_cure", 3, 3],
        46: ["brothel", 3, 7],
        47: ["clock", 3, 8],
        48: ["water_point", 2, 8],
        49: ["dentist", 1, 3],
        ...
        54: ["studio", 2, 6],
        55: ["photo_booth", 3, 5],
        56: ["charging_station", 1, 1],
        57: ["childcare", 2, 2],
        58: ["social_facility", 2, 9],
        59: ["sanitary_dump_station", 3, 8],
        60: ["courthouse", 2, 9],
        61: ["bicycle_rental", 2, 1],
        62: ["public_bookcase", 3, 2],
        63: ["dancing_studio", 3, 2],
        64: ["marketplace", 1, 5],
        65: ["reception_desk", 3, 9],
        66: ["binoculars", 3, 8],
        67: ["hospital", 1, 3],
        68: ["trolley_bay", 3, 1],
        69: ["luggage_locker", 3, 1],
        70: ["academy", 2, 2],
        71: ["financial_advice", 2, 5],
        72: ["dojo", 3, 2],
        73: ["gambling", 3, 6],
        74: ["fraternity", 3, 9],
        75: ["internet_cafe", 2, 7],
        76: ["letter_box", 2, 9],
        77: ["locker", 3, 1],
        78: ["prep_school", 2, 2],
        79: ["college", 1, 2],
        80: ["townhall", 2, 9],
        81: ["bicycle_repair_station", 2, 1],
        82: ["monastery", 2, 4],
        83: ["clinic", 1, 3],
        84: ["hookah_lounge", 3, 7],
        85: ["vehicle_inspection", 2, 1],
        86: ["casino", 2, 6],
        87: ["lounger", 3, 7],
        88: ["shower", 2, 3],
        89: ["loading_dock", 3, 1],
        90: ["disused", 3, 9],
        91: ["training", 2, 2],
        92: ["language_school", 2, 2],
        93: ["dancing_school", 2, 2],
        94: ["motorcycle_rental", 2, 1],
        95: ["social_centre", 2, 9],
        96: ["fixme", 3, 9],
        97: ["compressed_air", 3, 1],
        98: ["vacuum_cleaner", 3, 1],
        99: ["smoking_area", 3, 8],
        100: ["ticket_validator", 2, 1],
        101: ["give_box", 3, 9],
        102: ["bus_station", 1, 1],
        103: ["post_depot", 2, 9],
        104: ["arts_centre", 2, 6],
        ...
        107: ["police", 1, 3],
        108: ["cargo", 2, 1],
        109: ["funeral_hall", 2, 9],
        110: ["animal_shelter", 2, 3],
        111: ["mortuary", 3, 9],
        112: ["public_building", 2, 9],
        113: ["dressing_room", 3, 6],
        114: ["weighbridge", 3, 1],
        115: ["prison", 3, 9],
        116: ["animal_training", 3, 8],
        117: ["events_venue", 2, 6],
        118: ["outdoor_seating", 3, 7],
        119: ["building_yard", 3, 1],
        120: ["waste_transfer_station", 3, 8],
        121: ["clothes_dryer", 3, 5],
        122: ["grassland", 3, 8]
    }
